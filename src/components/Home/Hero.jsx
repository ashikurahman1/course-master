  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="container mx-auto ">
        <div className="overflow-hidden p-4 pt-30 pb-10 lg:pb-20  flex flex-col-reverse xl:flex-row items-center gap-10">
          {/* Left Text */}
          <div
            className="w-full xl:w-1/2 space-y-5 lg:space-y-10"
            data-aos="fade-right"
          >
          ...
          {/* Right Image */}
          <div
            className="xl:w-1/2 flex justify-center lg:justify-end relative"
            data-aos="fade-left"
            data-aos-delay="300"
          >
            ...
            <div className="p-3 border-teal-600 border-6 rounded-full z-50">
              <div className="bg-teal-600 rounded-full w-70 lg:w-120 h-70 lg:h-120 overflow-hidden">
                <img
                  src={heroImage}
                  alt="Hero Image"
