  ...
  return (
    <div className="bg-indigo-50">
      <section className="container mx-auto py-30 px-4">
        <div className="bg-linear-to-r from-indigo-500 via-80% to-purple-500 p-4 lg:p-10 rounded-lg shadow-lg ">
          <div className="overflow-hidden flex flex-col md:flex-row items-center justify-between py-15 gap-10">
            {/* Left Text */}
